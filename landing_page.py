...
from questions import wash_data,prepare_data, train_xgb_model, page_question1
def page_prediction():
    df = wash_data()
    X_train, X_test, y_train, y_test = prepare_data()
    model = train_xgb_model(X_train, y_train)
    page_question1(df, model)
# This section is to implement the home page of our app, where the dataset is displayed and the introduction of our app is shown.
def data_selected():
    '''
...
def page_home(): 
    ...
    st.markdown("<h1 style='text-align: center; font-size: 2em; font-weight: bold;'>Welcome to LoanPrediction</h1>", unsafe_allow_html=True) # Display the DataFrame below the welcome message 
